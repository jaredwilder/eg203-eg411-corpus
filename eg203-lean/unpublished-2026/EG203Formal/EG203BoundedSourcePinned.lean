/-
 ...
 Kernel-checkable Lean encoding of the FIRST TEN Codex source-pinned
 ...
 CROSS-PROVIDER SIGNATURE — three independent verifications:
 • Codex Python kernel: `eg203_source_pinned_minus_one_certificate_receipt.json`
 • Python re-run: `extract_lean_witness_data_v2.py` (2026-06-01)
 • Lean kernel: THIS FILE via `native_decide`.
